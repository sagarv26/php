...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
      <li class="active" style="color: blue"><a href="index.html">Home</a></li>
      <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href=page1.php>Education <span class="caret"></span></a>
        <ul class="dropdown-menu">
          ...
          <li><a href="test.php">Videos</a></li>
        </ul>
      </li>
...
<table>
  ...
  <tr>
    <td>1.</td>
    <td><a href="numbasics.php">Number Basics</a></td>
    <td></td>
  </tr>
    <td>2.</td>
    <td><a href="average.php">Average</a></td>
    <td></td>
  </tr>
  <tr>
    <td>3.</td>
    <td><a href="train.php">Train</a></td>
    <td></td>
  </tr>
  <tr>
    <td>4.</td>
    <td><a href="percentage.php">Percentage</a></td>
    <td></td>
  </tr>
  <tr>
    <td>5.</td>
